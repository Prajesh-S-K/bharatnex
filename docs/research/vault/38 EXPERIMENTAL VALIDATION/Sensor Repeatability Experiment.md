---
title: "Sensor Repeatability Experiment"
project: Geo-Sentry
type: research-note
status: requires-experiment
evidence-status: requires-experiment
created: 2026-08-30
...
tags:
  - "geo-sentry"
  - "research"
  - "38-experimental-validation"
---

# Sensor Repeatability Experiment

> [!experiment] Evidence status
> Requires a designed experiment. No result or performance value is claimed here.
...
- Parent domain: [[38 EXPERIMENTAL VALIDATION MOC]]
