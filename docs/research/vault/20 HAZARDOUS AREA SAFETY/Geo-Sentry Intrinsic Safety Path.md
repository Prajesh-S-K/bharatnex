---
title: "Geo-Sentry Intrinsic Safety Path"
project: Geo-Sentry
type: research-note
status: requires-certification-research
evidence-status: requires-certification-research
created: 2026-08-30
...
> [!danger] Evidence status
> Requires current regulatory, standards, or certification investigation before use.
