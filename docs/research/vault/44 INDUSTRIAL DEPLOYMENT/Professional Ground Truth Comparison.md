---
title: "Professional Ground Truth Comparison"
project: Geo-Sentry
type: research-note
status: requires-field-data
evidence-status: requires-field-data
created: 2026-08-30
...
tags:
  - "geo-sentry"
  - "research"
  - "44-industrial-deployment"
---

# Professional Ground Truth Comparison

> [!warning] Evidence status
> Requires genuine mine field data. Synthetic data may test software behaviour only.
...
- Parent domain: [[44 INDUSTRIAL DEPLOYMENT MOC]]
